...
trait EitherDBIOComponent { self: _root_.slick.jdbc.JdbcProfile =>
...
private[slick] object EitherDBIOComponent {
  private[slick] case class EitherLeftWrappingException[+L](left: L) extends RuntimeException("EitherDBIO left value", null, true, false)
}
